...
<body class="page-top">
    ...
    <div class="content">
        <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background-color: #5bc0de">
...
{{--            </button>--}}
            ...
            <button class="btn ">
                <i style="color: white"aria-hidden="true"> Principal</i>
            </button>

            <button class="btn ">
                <i style="color: white"aria-hidden="true">Comunidade</i>
            </button>
